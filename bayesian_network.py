...
def generateDAG(height, width):            
    ...
    for i in range(1,n+1):
        for j in range(1,m+1):
            if i==1:
                if j==1:
                    # El vértice Y11 siempre tiene los mismos vecinos:
                    # X21, X22 y X12
                    Modelo_Buscaminas.add_edges_from([('X21', 'Y11'),
                                                      ('X22', 'Y11'),
                                                      ('X12', 'Y11')])
                elif j==m:
                    # El vértice Y1,m posee siempre los mismo vecinos:
                    # X1,m-1 y X2,m y X2,m-1:
                ...
                # En esta rama, añadiremos las aristas de aquellos vértices Yi,j siendo 
                # 1<i<m. 
                if j==1:
                    # Subrama 1: se añaden las aristas para los vértices Yi,1
                    # y sus correspondientes vecinos
                    ...
                    # Subrama 2: se añaden las aristas para los vértices Yi,m y sus
                    ...
                    # Subrama 3: se añaden las aristas para los vértices Yi,j donde
                    # 1<j<m y sus correspondientes vecinos
